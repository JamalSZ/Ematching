...
# ======================
def load_data():
    csv_files = glob.glob('Exp_results/Exp_realworld/*.csv')
    dfs = []
...
if __name__ == "__main__":
    ...
    runtime_fig.savefig('Plots/runtime_by_dataset.png', bbox_inches='tight')
    ...
    memory_fig.savefig('Plots/memory_by_dataset.png', bbox_inches='tight')
